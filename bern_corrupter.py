...
class BernCorrupter:
    def __init__(self, data, n_ent, n_rel):
        self.bern_prob = self.get_bern_prob(data, n_rel)
        self.n_ent = n_ent
    ...
    def get_bern_prob(self, data, n_rel):
        '''
        data: should be a list of tensor: [head, tail, relation]
        n_rel: total number of types of relation
        '''
        head, tail, rela = data
